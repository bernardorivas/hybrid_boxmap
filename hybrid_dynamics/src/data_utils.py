...
class GridEvaluationResult:
    ...
    def load_json(cls, filepath: Union[str, Path]) -> GridEvaluationResult:
        ...
        return cls(
            ...
            metadata={k: v for k, v in metadata.items() 
                     if k not in ["grid_bounds", "grid_subdivisions", "sampling_mode", 
                                "num_points", "function_description", "total_boxes", "ndim"]}
        )
    ...
    def __repr__(self) -> str:
        ...
        return (f"GridEvaluationResult(boxes={self.total_boxes}, "
